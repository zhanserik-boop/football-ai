...
def build_gate_rows(
    ...
    for ah in ah_rows:
        ...
        output.append({
            ...
            "entry_handicap": clean(ah.get("current_handicap")),
            "entry_avg_odds": clean(ah.get("current_avg_odds")),
            "entry_best_odds": clean(ah.get("current_best_odds")),
            "entry_best_bookmaker": clean(ah.get("current_best_bookmaker")),
